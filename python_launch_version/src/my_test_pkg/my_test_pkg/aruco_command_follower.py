...
class ArucoCommandFollower(Node):
    def __init__(self):
        ...
        # Also publish to cmd_vel_nav so velocity_smoother gets the ArUco commands
        # when Nav2 is not in control
    ...
    def control_timer_callback(self):
        # Publish velocity commands if searching (Nav2 is NOT active in this state,
        # so direct /cmd_vel publishing is safe - collision_monitor is not publishing)
